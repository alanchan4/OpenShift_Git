...
# ======================
readTemplate("/u01/oracle/wlserver_12.1/common/templates/domains/wls.jar")
...
print('Creating Server - FET01 on Port 7001')
cd('/')
create('FET01', 'Server')
cd('Server/FET01')
set('ListenPort', 7001)

print('Creating Server - FET02 on Port 7003')
cd('/')
create('FET02', 'Server')
cd('Server/FET02')
set('ListenPort', 7003)
